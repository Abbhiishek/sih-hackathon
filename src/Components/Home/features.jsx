import Scholorship_Photo from '../../Images/scholorship.jpg'
import Socials_Photo from '../../Images/social-media.png'
import Events_Photo from '../../Images/events.jpg'
        ...
        <div className="container">
            ...
            <div id="scholorship" className="row overView--Scholorship overview--card mb-4">
                ...
                <div className="col-lg-6">
                    <h2>Scholorship <span className="celebration--icon">🎓</span></h2><br />
            ...
            <div className="row overView--Socials  overview--card mb-4">
                <div className="col-lg-6  ">
                    <h1>Social Hub<span className="celebration--icon">🐱‍🚀</span></h1><br />
            ...
            <div className="row overView--Aichat  overview--card mb-4">
                <div className="col-lg-6 ">
                    ...
                    <h2>AI Chat Bot <span className="celebration--icon">    🤖</span></h2><br />
